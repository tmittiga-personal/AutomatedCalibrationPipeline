...
def readout_weights_optimization(
    ...
    ringdown_len = 5 * u.us  # integration time after readout pulse to observe the ringdown of the resonator
    ...
    if simulate:
        ...
        ro_weights_opt_data = {
            ...
            'excited_trace': excited_trace, 
            'norm_subtracted_trace': norm_subtracted_trace,
        }
        data_folder = data_handler.save_data(ro_weights_opt_data, name=f"{resonator}_ro_weights_opt")
        plt.close()

        return weights_dict, data_folder
